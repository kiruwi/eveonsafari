...
const overview =
  "A week-long private safari covering Tarangire or Manyara, multiple Serengeti days, and a crater finale. Built-in flexibility lets you see both Tarangire and Manyara across the week, with ample time for big cats and migration viewing in the Serengeti.";

const tripTags = ["Wildlife lovers", "Photographers", "Families", "Luxury trip", "Honeymooners"];

const highlights = [
  "Seven-day sweep through Tarangire, Lake Manyara, Serengeti, and Ngorongoro.",
  "Elephants and baobabs in Tarangire; birdlife and tree-climbing lions in Manyara.",
  "Multiple Serengeti game drives for predators and migration herds in season.",
  "Ngorongoro Crater descent for dense Big Five opportunities.",
  "Private 4x4, expert guide, and park fees included.",
];
...
const itinerary = [
  {
    ...
    description:
      "Drive from Arusha to Lake Manyara (best Dec to May) or Tarangire (best Jun to Nov) with picnic lunch. Afternoon game drive in your chosen park.",
    meals: "Lunch, Dinner",
    overnight: "Endoro Lodge · Escarpment Luxury Lodge · Tarangire River Camp · Lemala Tarangire Camp",
  },
  {
    title: "Day 2 · Explore locally",
    description:
      "Optional additional game drive, guided walk, or biking around the escarpment, adjusting to wildlife movements and your interests.",
    meals: "Breakfast, Lunch, Dinner",
    overnight: "Karatu or Tarangire area lodge",
  },
  {
    title: "Day 3 · To Serengeti, afternoon drive",
    description:
      "Travel toward Serengeti with picnic lunch and wildlife stops. Settle into camp and head out for an afternoon drive.",
    meals: "Breakfast, Lunch, Dinner",
  ...
  },
  {
    ...
    description:
      "Morning and afternoon game drives. Focus on central Serengeti predators or move toward areas with migration herds if in season.",
    meals: "Breakfast, Lunch, Dinner",
    overnight: "Serengeti tented camps or lodges per selection",
  },
  {
    ...
    description:
      "Dawn drive on the plains, then journey toward Ngorongoro with optional stops at viewpoints or Maasai cultural visits.",
    meals: "Breakfast, Lunch, Dinner",
  ...
  },
  {
    ...
    description:
      "Descend into the crater for half-day game drive. Watch for lions, elephants, and rhino in a compact ecosystem.",
    meals: "Breakfast, Lunch, Dinner",
  ...
  },
  {
    ...
    description:
      "Relaxed breakfast and optional short stop if time allows, then drive back to Arusha or Kilimanjaro Airport.",
...
export const metadata = {
  title: "7-Day Northern Highlights Safari | Eve On Safari",
  description:
    "Week-long circuit through Tarangire, Lake Manyara, Serengeti, and Ngorongoro with private guide and flexible pacing.",
};
  ...
  return (
    <div className="bg-white">
      <section className="relative isolate overflow-hidden bg-[#0f0f0f] text-white">
        <Image
          src="/itenerary%20photos/route/Northern%20Highights.webp"
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-10 px-4 pb-16 pt-[28vh] md:grid-cols-[1.1fr_0.9fr] md:px-6 lg:px-0">
          <div className="space-y-6 text-center sm:text-left">
            <p className="text-xs uppercase tracking-[0.4em] text-[#ba7e47]">Seven days, four parks</p>
            <h1
              className="text-4xl font-semibold leading-tight sm:text-5xl"
              style={{ fontFamily: "var(--font-american-grunge, var(--font-title, inherit))" }}
            >
              7-Day Tanzania Safari:
              <span className="mt-1 block font-normal">Northern Highlights Adventure</span>
            </h1>
            <p className="text-sm text-white/85">
              Built-in time for both Tarangire and Manyara plus extended Serengeti drives and a crater finale.
            </p>
          ...
          <div className="rounded-[28px] bg-white/10 p-6 backdrop-blur-md">
            ...
            <ul className="mt-4 space-y-2 text-sm text-white/85">
              <li><strong className="text-white">Duration:</strong> 7 days / 6 nights</li>
              <li><strong className="text-white">Start and end:</strong> Arusha or Kilimanjaro Airport</li>
              <li><strong className="text-white">Best for:</strong> Comprehensive northern circuit with flexible routing</li>
              <li><strong className="text-white">Pricing:</strong> {formatPrice()}</li>
            </ul>
            <div className="mt-5 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/plan?package=7-day-northern-highlights"
        ...
        <aside className="space-y-5 lg:sticky lg:top-20 xl:top-[156px]">
          <div className="space-y-4 rounded-[24px] border border-[#c3c3c3] bg-white p-6 shadow-sm">
            ...
            <div className="space-y-2 text-sm text-[#231f20]/80">
              <p><strong className="text-[#231f20]">Duration:</strong> 7 days / 6 nights</p>
              <p><strong className="text-[#231f20]">Route:</strong> Tarangire, Manyara, Serengeti, Ngorongoro</p>
        ...
        <main className="space-y-12">
          ...
          <section className="space-y-4 rounded-[24px] border border-[#c3c3c3] bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between gap-3">
              ...
              <Link href="/plan?package=7-day-northern-highlights" className="text-sm font-semibold text-[#ba7e47]">
                Plan a safari →
              </Link>
            </div>
