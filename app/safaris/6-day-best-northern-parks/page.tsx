...
const overview =
  "Six days across the northern circuit with flexibility to linger in Tarangire when elephants and rare antelope peak or add time in the Serengeti for migration action. Lake Manyara, Ngorongoro Crater, and Serengeti combine for a balanced wildlife sweep.";

const tripTags = ["Wildlife lovers", "Photographers", "Families", "Luxury trip", "Honeymooners"];

const highlights = [
  "Top four parks of the northern circuit in one trip.",
  "Tarangire elephants and baobabs with rare antelope sightings.",
  "Lake Manyara forests, lakeshore birds, and possible tree-climbing lions.",
  "Two full days of Serengeti game drives with migration focus in season.",
  "Ngorongoro Crater finale for dense Big Five viewing.",
];
...
const itinerary = [
  {
    ...
    description:
      "Drive 2.5-3 hours from Arusha to Lake Manyara with lunch enroute. Afternoon game drive for Rift escarpment scenery, flamingos, and tree-climbing lions.",
    meals: "Lunch, Dinner",
    overnight: "Endoro Lodge · Escarpment Luxury Lodge · Tarangire River Camp · Lemala Tarangire Camp",
  },
  {
    title: "Day 2 · To Serengeti, game drive en route",
    description:
      "After breakfast, travel toward Serengeti with picnic lunch and game viewing en route. Settle into camp for an afternoon drive.",
  ...
  },
  {
    ...
    description:
      "Explore central Serengeti for big cats and resident game. Shift toward migration zones when herds are nearby.",
    meals: "Breakfast, Lunch, Dinner",
    overnight: "Serengeti tented camps or lodges per selection",
  },
  {
    title: "Day 4 · Serengeti to Ngorongoro area",
    description:
      "Morning drive in Serengeti, then travel toward Ngorongoro with wildlife stops along the way.",
    meals: "Breakfast, Lunch, Dinner",
  ...
  },
  {
    ...
    description:
      "Descend into the crater for a half-day game drive among elephants, lions, and rhino. Afternoon drive back toward Tarangire or Karatu.",
    meals: "Breakfast, Lunch, Dinner",
    overnight: "Karatu or Tarangire area lodge",
  },
  {
    title: "Day 6 · Tarangire or Manyara exit, return",
    description:
      "Optional morning game drive depending on routing, then return to Arusha or Kilimanjaro Airport.",
      ...
      <section className="relative isolate overflow-hidden bg-[#0f0f0f] text-white">
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-10 px-4 pb-16 pt-[28vh] md:grid-cols-[1.1fr_0.9fr] md:px-6 lg:px-0">
          <div className="space-y-6 text-center sm:text-left">
            <p className="text-xs uppercase tracking-[0.4em] text-[#ba7e47]">Six-day northern circuit</p>
            <h1
          ...
          <div className="rounded-[28px] bg-white/10 p-6 backdrop-blur-md">
            ...
            <ul className="mt-4 space-y-2 text-sm text-white/85">
              <li><strong className="text-white">Duration:</strong> 6 days / 5 nights</li>
              <li><strong className="text-white">Start and end:</strong> Arusha or Kilimanjaro Airport</li>
              <li><strong className="text-white">Best for:</strong> Balanced northern circuit with migration or elephant focus</li>
              <li><strong className="text-white">Pricing:</strong> {formatPrice()}</li>
            </ul>
            <div className="mt-5 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/plan?package=6-day-best-northern-parks"
        ...
        <aside className="space-y-5 lg:sticky lg:top-20 xl:top-[156px]">
          <div className="space-y-4 rounded-[24px] border border-[#c3c3c3] bg-white p-6 shadow-sm">
            ...
            <div className="space-y-2 text-sm text-[#231f20]/80">
              <p><strong className="text-[#231f20]">Duration:</strong> 6 days / 5 nights</p>
              <p><strong className="text-[#231f20]">Route:</strong> Manyara, Tarangire, Serengeti, Ngorongoro</p>
          ...
          <PesapalCheckoutButton
            packageName="6 Days Best of Northern Parks"
        ...
        <main className="space-y-12">
          ...
          <section className="space-y-4 rounded-[24px] border border-[#c3c3c3] bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between gap-3">
              ...
              <Link href="/plan?package=6-day-best-northern-parks" className="text-sm font-semibold text-[#ba7e47]">
                Plan a safari →
              </Link>
            </div>
