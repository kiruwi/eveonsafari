...
const overview =
  "Designed for travelers short on time who want the Serengeti straight away. Drive or fly in for sweeping plains, prime predator country, and seasonal migration viewing. Flexible starts with central Serengeti focus or Ndutu when the herds cluster in calving season.";

const tripTags = ["Wildlife lovers", "Photographers", "Families", "Luxury trip", "Honeymooners"];

const highlights = [
  "Scenic journey from Arusha toward Serengeti with Rift Valley views.",
  "Game drives across central Serengeti or Ndutu depending on season and migration.",
  "Sunset views and overnight in a lodge or tented camp inside the park.",
  "Chance to spot the Big Five plus cheetah-rich open plains.",
  "Professional private guide and 4x4 vehicle throughout.",
  "All park fees, meals, and accommodation included.",
];
...
const itinerary = [
  {
    ...
    description:
      "Depart Arusha after an early breakfast. Drive through the Rift Valley or opt for a morning flight to Serengeti. Settle into camp or lodge and head out for an afternoon game drive on the plains.",
    meals: "Lunch, Dinner",
    overnight:
      "Serengeti Simba Lodge or Halisi Mobile Camp (seasonal) · alternative central Serengeti tented camps",
  },
  {
    title: "Day 2 · Full-day Serengeti game drives",
    description:
      "Spend the day exploring with your guide. Focus on central Serengeti resident predators or shift south toward Ndutu for calving season and migration herds (Dec to Mar). Optional night game drive June to December near Simba Lodge in Ikoma.",
  ...
  },
  {
    ...
    description:
      "Enjoy a dawn game drive for big cat activity, return for breakfast, then transfer to the airstrip or begin the road journey back to Arusha or Kilimanjaro Airport.",
      ...
      <section className="relative isolate overflow-hidden bg-[#0f0f0f] text-white">
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-10 px-4 pb-16 pt-[28vh] md:grid-cols-[1.1fr_0.9fr] md:px-6 lg:px-0">
          <div className="space-y-6 text-center sm:text-left">
            <p className="text-xs uppercase tracking-[0.4em] text-[#ba7e47]">Serengeti in 72 hours</p>
            <h1
          ...
          <div className="rounded-[28px] bg-white/10 p-6 backdrop-blur-md">
            ...
            <ul className="mt-4 space-y-2 text-sm text-white/85">
              ...
              <li><strong className="text-white">Best for:</strong> Fast Serengeti immersion and seasonal migration focus</li>
              <li><strong className="text-white">Pricing:</strong> {formatPrice()}</li>
            </ul>
            <div className="mt-5 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/plan?package=3-day-serengeti-escape"
        ...
        <aside className="space-y-5 lg:sticky lg:top-20 xl:top-[156px]">
          <div className="space-y-4 rounded-[24px] border border-[#c3c3c3] bg-white p-6 shadow-sm">
            ...
            <div className="space-y-2 text-sm text-[#231f20]/80">
              ...
              <p><strong className="text-[#231f20]">Route:</strong> Serengeti central or Ndutu (seasonal) with private guide</p>
          ...
          <PesapalCheckoutButton
            packageName="3 Days Quick Serengeti Escape"
        ...
        <main className="space-y-12">
          ...
          <section className="space-y-4 rounded-[24px] border border-[#c3c3c3] bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between gap-3">
              ...
              <Link href="/plan?package=3-day-serengeti-escape" className="text-sm font-semibold text-[#ba7e47]">
                Plan a safari →
              </Link>
            </div>
